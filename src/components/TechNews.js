...
const url =
  "https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=6ca34c820cce443f9ae46a62aef41555";
...
class NewsFeeds extends Component {
  ...
  static navigationOptions = {
    header: <Head headerTitle="Tech News" IconName="menu" />
  };
  render() {
    return (
      <FlatList
